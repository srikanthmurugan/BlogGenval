            ...
            <div class="flex flex-wrap ">
                <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
                    <div class="lg:max-w-md">
                        ...
                        This the new and Advanced blog channel where you can use this channel as your own dynamically. This is our property use it efficiently !
                        </p>
                        <div class="flex flex-wrap items-center">
                            <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                                <div class="p-6 bg-white dark:bg-gray-900">
                                    ...
                                    <p class="mt-4 mb-2 text-3xl font-bold text-gray-700 dark:text-gray-400">{count}
                                    </p>
                                    <h2 class="text-sm text-gray-700 dark:text-gray-400">Posted Blogs</h2>
                                </div>
                            </div>
                            <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                                <div class="p-6 bg-white dark:bg-gray-900">
